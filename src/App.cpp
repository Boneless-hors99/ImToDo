...
// Optional: if I end up needing a GL loader (glad, gl3w, etc.), include/init it here
// #include <glad/glad.h>
...
App::App()
{
    ...
    m_window = glfwCreateWindow(1280, 720, "ImGui Docking Demo - imtodo", nullptr, nullptr);
    if (m_window == nullptr)
    {
        glfwTerminate();
        return;
